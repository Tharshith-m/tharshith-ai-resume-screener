...
//       setJobTitle("Searched Job"); // Replace with dynamic title if needed
...
//   // Generate a cache key for current search params
...
//   // Save results in localStorage with key
...
//       prepareCSV(results);
//       saveToCache(cacheKey, results); // Save to localStorage
//       setWarning("");
//     } catch (err) {
//       console.error(err);
//       setWarning("Error fetching candidates. Try again later.");
