...
from app.config.opensearch_config import opensearch_client as client  # Assuming you have a config file for OpenSearch client
...
async def get_resume_by_email(email: str = Query(..., example="someone@example.com")):
    try:
        ...
        if response["hits"]["total"]["value"] == 0:
            raise HTTPException(status_code=404, detail="No resume found for this email.")
